...
export function createTransformerPlugin(): KernelPlugin {
  ...
  nodes.set('Wo', [
    ...
    createNode('build_k_projection', (g) => {
      const result = {
        ...g,
    ...
    createNode('build_v_projection', (g) => {
      const result = {
        ...g,
    ...
    createNode('build_attention_mask', (g) => {
      const result = {
        ...g,
  ...
  nodes.set('Sek', [
    createNode('compute_qk_attention', (g) => {
      const result = {
        ...g,
        name: 'QKAttentionGraph',
        nodes: [...g.nodes],
        edges: [...g.edges, ['q_proj', 'k_proj'] as [string, string]],
        data: g.data
      };
    ...
    createNode('apply_attention_to_v', (g) => {
      const result = {
        ...g,
        name: 'AttentionOutputGraph',
        nodes: [...g.nodes, 'attn_output'],
        edges: [...g.edges, ['attn_probs', 'v_proj'] as [string, string]],
        data: g.data
      };
  ...
  return createPlugin('TransformerPlugin', nodes);
}
